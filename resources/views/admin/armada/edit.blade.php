                    ...
                    <form class="form" action="{{ route('admin.armada.update', $data->id) }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Masukan Jumlah Seat</label>
                                    <input type="number" class="form-control @error('jml_seat') is-invalid @enderror"
                                        name="jml_seat" value="{{ $data->jml_seat }}" autocomplete="off">
                                    @error('jml_seat')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Masukan Konfigurasi Seat</label>
                                    <input type="text" class="form-control @error('konfigurasi_seat') is-invalid @enderror"
                                        name="konfigurasi_seat" value="{{ $data->konfigurasi_seat }}" autocomplete="off">
                                    @error('konfigurasi_seat')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    @enderror
