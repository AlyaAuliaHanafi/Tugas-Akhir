    ...
    <section class="detail">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <h2>{{ $data->title }}</h2>
                    <p> Memiliki konfigurasi seat {{$data->konfigurasi_seat}} dengan jumlah seat {{$data->jml_seat}} </p>
                    <h3>Fasilitas :</h3>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="d-flex">
                    ...
                    <a href="https://wa.me/6283879589065" class="btn btn-warning">Hubungi Kami</a>
                </div>
            </div>
        </div>
    </section>
