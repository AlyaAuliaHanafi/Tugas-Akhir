    ...
    <section class="unggul" id="tentang">
        <div class="container">
            <div class="mt-4 p-5 jumbo">
                ...
                <p class="text-center">
                    Penuhi kebutuhan perjalanan group Anda bersama Bus Alfariz Trans.
                    Nikmati perjalanan dengan segala fasilitas yang kami sediakan mulai 
                    dari Wifi, LCD Screen, Karouke, dan USB Charger.
                    Kami selalu mengedepankan keselamatan, kenyamanan, ketepatan waktu dan pelayanan yang terbaik untuk Anda.
                ...
                <div class="row justify-content-center">
                    <div class="col-md-5">
                        <div class="d-flex">
                            <div class="icon">
                                <img src="{{ asset('fe/img/time.png') }}" alt="">
                            </div>
                            <h3>Tepat Waktu</h3>
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="d-flex">
                            <div class="icon">
                                <img src="{{ asset('fe/img/comfortable.png') }}" alt="">
                            </div>
                    ...
                    <div class="col-md-5 mt-4">
                        <div class="d-flex">
                            <div class="icon">
                                <img src="{{ asset('fe/img/pelayanan.png') }}" alt="">
                            </div>
                    ...
                    <div class="col-md-5 mt-4">
                        <div class="d-flex">
                            <div class="icon">
                                <img src="{{ asset('fe/img/singer.png') }}" alt="">
                            </div>
